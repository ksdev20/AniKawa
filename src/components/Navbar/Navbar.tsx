        ...
        <header>
            ...
            <aside className={`log-sign-overlay ${personOpen ? 'show' : 'hidden'}`} id="log-sign-overlay" onClick={(e) => {
                ...
                <div id="before-login" className={`corner-box ${isLoggedIn ? 'hidden' : ''}`}>
                    <a aria-label='Signup' className="corner-box-btn" id="signup-btn" href="/signup/">
                        <div className="corner-box-btn-text">
                            <div className="cbt-white">Create Account</div>
                            <div className="cbt-gray">Join for free !</div>
                        </div>
                    </a>
                    <a aria-label='Login' className="corner-box-btn" id="login-btn" href="/login/">
                        <div className="corner-box-btn-text">
                ...
                <div id="after-login" className={`corner-box ${isLoggedIn ? '' : 'hidden'}`}>
                    <a aria-label='Profile Page' href="/profile" className="corner-box-btn cbb-account bd-bottom">
                        ...
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="26px" viewBox="0 -960 960 960" width="26px"
                            fill="#ffffff">
                            <path
                    ...
                    <button aria-label='Watchlist' id="watchlist-btn-person" className="corner-box-btn cbb-whl" onClick={() => {handleClickWatHis('watchlist')}}>
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="26px" viewBox="0 -960 960 960" width="26px"
                            fill="#ffffff">
                            <path
                    ...
                    <button aria-label='Watch History' id="history-btn-person" className="corner-box-btn cbb-whl bd-bottom" onClick={() => {handleClickWatHis('history')}}>
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="26px" viewBox="0 -960 960 960" width="26px"
                            fill="#ffffff">
                            <path
                    ...
                    <button aria-label='Logout' id="logout-btn-person" className="corner-box-btn cbb-whl" onClick={() => logout()}>
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="26px" viewBox="0 -960 960 960" width="26px"
                            fill="#ffffff">
                            <path
