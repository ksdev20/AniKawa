...
export function getCatHead(mainCategory: str) {
    ...
    const pageUrl = `${frontendUrl}/category/${mainCategory}`;
    const backdrop = `${frontendUrl}/anikawa-category-og-img-pc.png`;
...
export function getSubCatHead(mainCategory: str, subCategory: str) {
    ...
    const pageUrl = `${frontendUrl}/category/${mainCategory}/${subCategory}`;
    const backdrop = `${frontendUrl}/anikawa-sub-category-og-img-pc.png`;
