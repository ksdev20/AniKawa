import { createAndAppendAnimeCard, createAnimeCard, genreCheck, getCurrentDate, getYear, getScore, fetchWatchlist, slidersHandler } from "./anime-card.mjs";
import { aniOneAsiaDataAnilist3 } from "./data/aniOneAsiaDataAnilist3.mjs";

function createSlider(cat) {
    return `<div id="${cat}-slider" class="anime-slider-section cat-slider sl">
...
function main() {
    ...
    for (const category of categories) {
        ...
        cardElement.addEventListener('click', () => {
            ...
            window.location.href = "/category/sub-category.html";
        });
...
<div class="mid-section">
    <div class="trial-box">
        <img class="trial-box-logo" src="assets/icons/cr-logo-removebg-preview.png" />
        <div class="trial-box-text">
            <label class="trial-box-text-big">Frunchyroll: Watch Anime Anytime, Anywhere</label>
            <label class="trial-box-text-small">Get all anime and games ad-free, plus download content! Try it free
                for 7 days. Cancel anytime.</label>
        </div>
        <div class="start-trial-btn">START FREE TRIAL</div>
    </div>
</div>
*/